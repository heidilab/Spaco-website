        ...
        <div className="space-y-2">
          <div className="rounded-xl bg-emerald-50 border border-emerald-200 p-4">
            ...
            <p className="font-mono text-2xl font-bold text-emerald-900 tracking-widest">
              {formatPasscode(existing.passcode, booking.venueId)}
            </p>
          ...
          <div className="flex flex-wrap gap-2">
            ...
            {(() => {
              ...
              const message = locale === 'zh'
                ? `你好！你嘅 SPACO 預訂 (${venueName} · ${booking.date} ${booking.startTime}) 嘅門鎖密碼係：\n\n🔑 ${formatPasscode(existing.passcode, booking.venueId)}\n\n請喺活動當日到場時，喺鎖嘅鍵盤輸入數字後撳「${lockConfirmKey(booking.venueId)}」掣即可進場。如有任何問題請隨時 WhatsApp 我哋。`
                : `Hi! Your SPACO booking (${venueName} · ${booking.date} ${booking.startTime}) lock passcode:\n\n🔑 ${formatPasscode(existing.passcode, booking.venueId)}\n\nOn arrival, enter the digits then press \u201c${lockConfirmKey(booking.venueId)}\u201d on the keypad to unlock. WhatsApp us anytime if you run into trouble.`;
